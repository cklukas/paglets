...
from paglets.core.errors import LifecycleError, NotHandledError, TransferError
from paglets.core.messages import Message
from paglets.core.runtime_values import ArrivalMode, ServiceScope
...
class ServiceAgent(Paglet[ServiceState]):
    ...
    def on_creation(self, event):
        self.advertise_service(
            "quotes", capabilities=("quote", "price"), metadata={"version": 1}, scope=ServiceScope.MESH
        )
